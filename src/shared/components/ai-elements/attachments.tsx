...
const renderAttachmentImage = (url: string, filename: string | undefined, isGrid: boolean) =>
  isGrid ? (
    <Image alt={filename || "Image"} className="size-full object-cover" height={96} src={url} width={96} />
  ) : (
    <Image alt={filename || "Image"} className="size-full rounded object-cover" height={20} src={url} width={20} />
  );
